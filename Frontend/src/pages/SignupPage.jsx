...
// import InputsTypes from "../component/InputsTypes";
      ...
      >
        <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button type='submit'
                      ...
                      {loading ? (
                         <>
                <Loader className="mr-3 h-5 w-5 animate-spin" aria-hidden="true"/>
                Loading...
                </>
                      ): (
                        <>
		...
		<Link to="/login" className="font-medium text-purple-400 hover:text-purple-500">
			Login Here <ArrowRight className="inline-block h-4 w-4 ml-1" />
		</Link>
		</p>
      </motion.div>
      </motion.div>
